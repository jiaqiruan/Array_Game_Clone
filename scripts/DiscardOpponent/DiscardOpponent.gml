...
function DiscardOpponent(){
	if(!ds_list_empty(opponent_list)){
		var card = opponent_list[|ds_list_size(opponent_list)-1];
		ds_list_delete(opponent_list,ds_list_size(opponent_list)-1);
		card.facing_up = true;
